...
<body>
  ...
  <div class="heading text-center mx-auto">
    <h3 class="head">Welcome To My Service</h3>
    </div>
    <div class="container py-md-3">
    <p class="my-3 head"> Berikut beberapa service yang bisa saya tawarkan : </p>
  </div>
      <?php
    ...
    if (isset($_POST["id"])) {
        ...
        $sql = "UPDATE service SET nama='".$nama."', keahlian='".$keahlian."',";
        $runSQL = mysqli_query($conn, $sql);
  ...
  <div class="container py-md-3">
    ...
    <div class="container py-md-3">
      <a href="edit_service.php?id=<?php echo $row["id"] ?>" class="btn-primary btn btn-style mt-lg-5 mt-4">Edit service
      </a>
    </div> 
  </div>
<!-- Tutup service !-->
