...
<head>
  ...
  <title> Personal Portfolio Category</title>
  <!-- web fonts -->
  ...
  <section class="w3l-contacts-12" id="contact">
      ...
      <div class="container py-md-3">
        ...
        <div class="row cont-main-top">
          ...
          <div class="contacts12-main col-lg-6 ">
            <!-- Buat Malem Nanti input contact ke database !-->
            <?php
            include "koneksi.php";
            ?>
    <?php 
    if (isset($_POST['tombol'])) {  
        ...
        $pesan = $_POST['pesan']; 
         ...
         //buat koneksi
         $strsql = "INSERT INTO contact (nama, email, pesan) 
    ...
    ?>
            <form action="contact.php" method="post" class="main-input" novalidate="novalidate">
              <div class="top-inputs d-grid">
                <!--Nama !-->
              <input class="form-control" name="nama" type="text" placeholder="Your Name *" data-validation-required-message="Please enter your name." required />
              </div>
              <!--email !-->
              <input class="form-control" name="email" type="email" placeholder="Your Email *" data-validation-required-message="Please enter your email address." required />
              <!--Pesan !-->
              <textarea placeholder="pesan" name="pesan" type="text" required></textarea>
              <div class="text-right">
                <!--Submit !-->
              <button class="btn btn-theme2" name="tombol" type="submit">
              Send Message</button>
              </div>
                    ...
                    <div class="cont-subs">
                        <div class="cont-add">
                           ...
                           <div class="cont-add-rgt">
                            <p class="contact-text-sub">Kihajar Dewantara No 11 Ciputat.Tangerang Selatan</p>
                        </div>
                        ...
                        <div class="cont-add add-2">
                          ...
                          <a href="mailto:info@example.com">
                                <p class="contact-text-sub">wchandra21@gmail.com</p>
                            </a>
                        </div>
                        ...
                        <div class="cont-add">
                            ...
                            <div class="cont-add-rgt">
                                 <a href="tel:+7-800-999-800">
                                    <p class="contact-text-sub">+62-89693602963</p>
                                 </a>
                            </div>
                        </div>
                        </div>
