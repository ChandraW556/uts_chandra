...
<head>
  ...
  <title>My Website a Personal Portfolio Category Bootstrap Responsive Website Template</title>
  <!-- web fonts -->
            ...
            <!-- Isi variabel !-->
              <div class="col-lg-7 content-left mt-lg-0 mt-5 pl-lg-5">
                <div id="listtable" class="w3-content putih" style="max-width:700px">
                    ...
                    <a href="edit_about.php?id=<?php echo $row["id"] ?>" class="btn-theme2 btn mt-lg-5 mt-4">Edit Isi </a>
